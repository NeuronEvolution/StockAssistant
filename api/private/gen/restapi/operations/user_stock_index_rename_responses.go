...
/*UserStockIndexRenameDefault Error response

swagger:response userStockIndexRenameDefault
*/
type UserStockIndexRenameDefault struct {
	...
	/*
	  In: Body
	*/
	Payload *models.UserStockIndexRenameDefaultBody `json:"body,omitempty"`
}

// NewUserStockIndexRenameDefault creates UserStockIndexRenameDefault with default headers values
...
// WithStatusCode adds the status to the user stock index rename default response
func (o *UserStockIndexRenameDefault) WithStatusCode(code int) *UserStockIndexRenameDefault {
	o._statusCode = code
	return o
}

// SetStatusCode sets the status to the user stock index rename default response
func (o *UserStockIndexRenameDefault) SetStatusCode(code int) {
	o._statusCode = code
}

// WithPayload adds the payload to the user stock index rename default response
func (o *UserStockIndexRenameDefault) WithPayload(payload *models.UserStockIndexRenameDefaultBody) *UserStockIndexRenameDefault {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the user stock index rename default response
func (o *UserStockIndexRenameDefault) SetPayload(payload *models.UserStockIndexRenameDefaultBody) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *UserStockIndexRenameDefault) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
